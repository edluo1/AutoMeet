...
public class TimeSlotDetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            ...
            arguments.putString(TimeSlotDetailFragment.ARG_ITEM_ID,
                    getIntent().getStringExtra(TimeSlotDetailFragment.ARG_ITEM_ID));
            TimeSlotDetailFragment fragment = new TimeSlotDetailFragment();
            fragment.setArguments(arguments);
            getSupportFragmentManager().beginTransaction()
                    .add(R.id.timeslot_detail_container, fragment)
                    .commit();
        }
    }
